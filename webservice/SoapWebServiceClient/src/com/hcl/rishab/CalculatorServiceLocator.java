...
public class CalculatorServiceLocator extends org.apache.axis.client.Service implements com.hcl.rishab.CalculatorService {
    ...
    private java.lang.String Calculator_address = "http://192.168.1.118:8085/WsSoapDem/services/Calculator";
    ...
    public com.hcl.rishab.Calculator getCalculator(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.hcl.rishab.CalculatorSoapBindingStub _stub = new com.hcl.rishab.CalculatorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.hcl.rishab.Calculator.class.isAssignableFrom(serviceEndpointInterface)) {
                com.hcl.rishab.CalculatorSoapBindingStub _stub = new com.hcl.rishab.CalculatorSoapBindingStub(new java.net.URL(Calculator_address), this);
                _stub.setPortName(getCalculatorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://rishab.hcl.com", "CalculatorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://rishab.hcl.com", "Calculator"));
        }
