...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements com.faultdemo.HelloWorldService {
    ...
    private java.lang.String HelloWorldPort_address = "http://127.0.0.1:4444/hello";
    ...
    public com.faultdemo.HelloWorld getHelloWorldPort() throws javax.xml.rpc.ServiceException {
    ...
    public com.faultdemo.HelloWorld getHelloWorldPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.faultdemo.HelloWorldPortBindingStub _stub = new com.faultdemo.HelloWorldPortBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.faultdemo.HelloWorld.class.isAssignableFrom(serviceEndpointInterface)) {
                com.faultdemo.HelloWorldPortBindingStub _stub = new com.faultdemo.HelloWorldPortBindingStub(new java.net.URL(HelloWorldPort_address), this);
                _stub.setPortName(getHelloWorldPortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://faultdemo.com/", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://faultdemo.com/", "HelloWorldPort"));
        }
