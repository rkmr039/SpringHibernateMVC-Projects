...
public class HelloWorldProxy implements com.faultdemo.HelloWorld {
  private String _endpoint = null;
  private com.faultdemo.HelloWorld helloWorld = null;
  ...
  private void _initHelloWorldProxy() {
    try {
      helloWorld = (new com.faultdemo.HelloWorldServiceLocator()).getHelloWorldPort();
      if (helloWorld != null) {
        if (_endpoint != null)
  ...
  public com.faultdemo.HelloWorld getHelloWorld() {
    if (helloWorld == null)
      _initHelloWorldProxy();
    return helloWorld;
  }
